...
// NeuralNetworkComponent.tsx — fully typed TSX version
// Usage: import NeuralNetwork from './NeuralNetworkComponent';
// If using Next.js: dynamic(() => import('./NeuralNetworkComponent'), { ssr: false })
...
export default function NeuralNetwork(): JSX.Element {
      ...
      <div id="theme-selector" className="glass-panel">
        <div style={{ flex: 1 }}>
          ...
          <div className="theme-grid">
            <button className="theme-button active" id="theme-1" data-theme="0" aria-label="Purple Nebula"></button>
            <button className="theme-button" id="theme-2" data-theme="1" aria-label="Sunset Fire"></button>
            <button className="theme-button" id="theme-3" data-theme="2" aria-label="Ocean Aurora"></button>
          </div>
        </div>
        <div id="density-controls" style={{ flex: 1 }}>
          <div className="density-label"><span>Density</span><span id="density-value">100%</span></div>
          <input type="range" min="30" max="100" defaultValue={100} className="density-slider" id="density-slider" aria-label="Network Density" onInput={(e) => (e.currentTarget.style.setProperty("--val", `${e.currentTarget.value}%`))} />
        </div>
      </div>
      <div id="control-buttons">
        <button id="change-formation-btn" className="control-button"><span>Morph</span></button>
        <button id="pause-play-btn" className="control-button"><span>Freeze</span></button>
        <button id="reset-camera-btn" className="control-button"><span>Reset</span></button>
      </div>
